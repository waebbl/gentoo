...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-3.6.5-0001-find-versioned-openexr.patch
)
...
src_prepare() {
#	rm CMakeModules/Findilmbase.cmake CMakeModules/FindOpenEXR.cmake || die
	cmake_src_prepare
	mv CMakeModules/Findilmbase.cmake CMakeModules/FindIlmBase.cmake || die
}
