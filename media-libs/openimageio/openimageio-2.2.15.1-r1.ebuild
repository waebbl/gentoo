...
"
# TODO: supports imath/openexr:3 already, but needs osl needs to be built
#		with the same API as oiio and does not support v3.
RDEPEND="
	>=dev-libs/boost-1.62:=
	dev-cpp/robin-map
	dev-libs/libfmt:=
...
PATCHES=( "${FILESDIR}"/${P}-0001-use-correct-include-dir.patch )
